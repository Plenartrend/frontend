...
import { Bell, Search, X, ChevronRight, FileText, User as UserIcon, Flag, LogOut, Settings } from "lucide-react";
...
export function Header() {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-white px-6 shadow-sm relative z-20">
      <div className="flex flex-1 items-center">
        <div className="relative w-full max-w-md" ref={searchRef}>
          ...
          <input
            ...
            placeholder="Suche nach Themen, Politikern oder Kampagnen..."
            value={searchQuery}
      ...
      <div className="flex items-center gap-x-4 relative">
        {user && (
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 top-full mt-2 w-80 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
